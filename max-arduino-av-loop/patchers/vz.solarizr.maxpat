...
,
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"description" : "Solarize a video",
		"digest" : "",
		"tags" : "Vizzie Effect, solarizr",
		"style" : "",
		"subpatcher_template" : "",
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1429.0, 162.5, 74.0, 22.0 ],
					"text" : "exact_menu"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1395.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hint" : "Set the color mode for the image (black and white or color).",
...
, 			{
				"box" : 				{
					...
					"hint" : "Set the luminance of the solarization function.",
					"id" : "obj-8",
					"maxclass" : "live.dial",
...
, 			{
				"box" : 				{
					...
					"appearance" : 1,
					"dialcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the tolerance of the solarization function.",
					"id" : "obj-10",
					"maxclass" : "live.dial",
					"needlecolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the value for the luminance control",
					"id" : "obj-85",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 1061.1666259765625, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the value for the tolerance control",
					"id" : "obj-53",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 1234.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"hint" : "Set the saturation of the RGB color for the solarization color",
					"id" : "obj-73",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 890.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"floatoutput" : 1,
					"hint" : "Set the saturation level for the solarization color.",
					"id" : "obj-46",
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 0.165741, 0.364658, 0.14032, 1.0 ],
					"hint" : "Set the Blue part of the RGB color for the solarization color",
					"id" : "obj-54",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 748.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 0.165741, 0.364658, 0.14032, 1.0 ],
					"hint" : "Set the Red part of the RGB color for the solarization color",
					"id" : "obj-62",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 480.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 0.165741, 0.364658, 0.14032, 1.0 ],
					"hint" : "Set the Green part of the RGB color for the solarization color",
					"id" : "obj-64",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 614.0, 169.5, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"hint" : "Set the solarization color",
					"id" : "obj-27",
					"maxclass" : "swatch",
					"numinlets" : 3,
					"numoutlets" : 2,
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Solarization color",
							"parameter_shortname" : "Solarization color",
							"parameter_type" : 3
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1360.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1021.1666259765625, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the value for the luminance control",
					"id" : "obj-82",
					"index" : 6,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1194.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the value for the tolerance control",
					"id" : "obj-49",
					"index" : 7,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 855.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the saturation of the RGB color for the solarization color",
					"hint" : "Set the saturation of the RGB color for the solarization color.",
					"id" : "obj-74",
					"index" : 5,
					"maxclass" : "inlet",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 239.0, 647.0, 165.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 257.0, 597.0, 67.0, 22.0 ],
					"text" : "vzgl-object"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : [ 0.190473817762402, 0.930039215686275, 0.018980392156863, 1.0, 0.301960784313725, 0.96, 0.474509803921569 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 715.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 446.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 580.0, 129.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the Red part of the RGB color for the solarization color",
					"id" : "obj-20",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Set the Green part of the RGB color for the solarization color",
					"id" : "obj-31",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Set the Blue part of the RGB color for the solarization color",
					"id" : "obj-35",
					"index" : 4,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 410.5, 98.0, 23.0 ],
					"text" : "glow $1 $2 $3 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 765.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1238.0, 160.5, 1243.0, 160.5 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1404.0, 160.5, 1404.0, 160.5 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 724.5, 124.468765258789062, 724.5, 124.468765258789062 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 759.0, 160.5, 757.0, 160.5 ],
					"source" : [ "obj-47", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1203.5, 124.468765258789062, 1203.5, 124.468765258789062 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 490.0, 160.5, 489.0, 160.5 ],
					"source" : [ "obj-57", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 455.5, 582.5, 248.5, 582.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 624.0, 160.5, 623.0, 160.5 ],
					"source" : [ "obj-63", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 899.0, 160.5, 899.0, 160.5 ],
					"source" : [ "obj-72", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 864.5, 124.468765258789062, 864.5, 124.468765258789062 ],
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1065.1666259765625, 160.5, 1070.1666259765625, 160.5 ],
					"source" : [ "obj-80", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1030.6666259765625, 124.468765258789062, 1030.6666259765625, 124.468765258789062 ],
					"source" : [ "obj-82", 0 ]
				}
